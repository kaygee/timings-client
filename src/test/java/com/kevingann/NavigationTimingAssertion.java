...
public class NavigationTimingAssertion {
  ...
  public void canBeObtained() {
    ...
    NavigationTimingRequest navigationTimingRequest =
        new NavigationTimingRequest.Builder()
            .injectJS(injectJS)
    ...
    NavigationTimingResponse navigationTimingResponse =
        timingsFacade.getNavigationTiming(navigationTimingRequest);
  }

  /**
   * Attempt to send the request with the minimum set of attributes. These were obtained from the
   * documentation at
   * https://github.com/godaddy/timings#common-parameters-navtiming-usertiming-and-apitiming
   */
  @Test
  public void canUseMinimumRequiredFields() {
    ...
    Log log =
        new Log.Builder()
            .team("My team")
            .browser("Chrome")
            .environmentTester("Kevin Gann")
            .environmentTarget("The Moon")
